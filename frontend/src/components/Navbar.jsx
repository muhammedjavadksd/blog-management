...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-10 lg:px-20 py-4 bg-gradient-to-r bg-black shadow-lg">
      {/* Logo */}
      ...
      <div className="hidden md:flex items-center space-x-4">
        {user ? (
          ...
          <Link to="/login">
            <button className="bg-gradient-to-r bg-black text-white font-semibold py-1 px-4 rounded-full shadow-md hover:shadow-lg transition-transform duration-300 hover:scale-105">
              Login
            </button>
          </Link>
        )}
